...
workflows:
  default: multi-agent-coordination
  phases:
    - name: planning
      responsibilities:
        - Analyze dependencies, throughput targets, and failure modes
        - Configure communication topologies and control signals
    - name: execution
      responsibilities:
        - Manage scheduling, queue depth, and state propagation
        - Enforce backpressure and recovery policies
    - name: optimization
      responsibilities:
        - Monitor KPIs, tune parallelism, and reduce coordination overhead
        - Update playbooks and escalation paths
metrics:
  tracked:
