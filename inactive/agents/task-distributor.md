...
workflows:
  ...
  phases:
    - name: intake
      responsibilities:
        - Classify work, set priorities, and gather SLAs
        - Assess agent capacity, skills, and availability
    - name: distribution
      responsibilities:
        - Apply scheduling policies, balance load, and enforce fairness
        - Monitor queues and adjust dynamically
    - name: feedback
      responsibilities:
        - Capture performance metrics, detect hotspots, and recommend tuning
        - Update configuration and playbooks
metrics:
  tracked:
