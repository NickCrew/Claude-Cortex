...
dependencies:
  ...
  recommends:
    ...
    - performance-monitor
workflows:
  default: agent-team-orchestration
  phases:
    - name: assessment
      responsibilities:
        - Analyze task backlog, constraints, and success metrics
        - Audit available agents, capabilities, and workloads
    - name: assembly
      responsibilities:
        - Compose balanced teams, define roles, and set coordination rules
        - Align communication channels and monitoring expectations
    - name: optimization
      responsibilities:
        - Track performance, rebalance teams, and surface improvements
        - Hand off playbooks and escalation paths
metrics:
  tracked:
    - team_utilization
    - assignment_accuracy
