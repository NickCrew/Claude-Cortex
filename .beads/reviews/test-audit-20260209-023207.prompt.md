...
Read the source files at `/Users/nferguson/Developer/claude-cortex/scripts/validate_registry.py` and list every public behavior:
...
Read the test files at `/Users/nferguson/Developer/claude-cortex/tests/unit/core/test_skills.py` and mark each behavior from Step 3 as:
...
```
/Users/nferguson/Developer/claude-cortex/.beads/reviews/test-audit-20260209-023207.md
```
...
- **Module path:** `/Users/nferguson/Developer/claude-cortex/scripts/validate_registry.py`
- **Test path:** `/Users/nferguson/Developer/claude-cortex/tests/unit/core/test_skills.py`
- **Mode:** full
